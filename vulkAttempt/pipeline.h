...
PINLINE bool create_object_shader(vulkan_types* context, bool is_wireframe, vulkan_object_shader* out_shader)
{
        ...
        VkDescriptorSetLayoutCreateInfo global_layout_info = {0};
        global_layout_info.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO;
        global_layout_info.pNext = 0;
        ...
        // Multisampling.
        VkPipelineMultisampleStateCreateInfo multisampling_create_info = {0}; multisampling_create_info.sType = VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO;
        ...
        VkPipelineColorBlendStateCreateInfo color_blend_state_create_info = {0}; color_blend_state_create_info.sType = VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO;
