...
bool vulkan_object_shader_update_global_state(vulkan_types* context) {
        ...
        // Copy data to buffer
        vulkan_buffer_load_data(context, &context->main_shader.global_uniform_buffer, offset, range, 0, &context->main_shader.global_ubo);
        
        VkDescriptorBufferInfo bufferInfo;
        bufferInfo.buffer = context->main_shader.global_uniform_buffer.handle;
        ...
        descriptor_write.dstSet = context->main_shader.global_descriptor_sets[image_index];
