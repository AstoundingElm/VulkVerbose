...
PINLINE bool create_instance(vulkan_types* context)
{
        context->instance_context.allocator = 0;
	...
	VkValidationFeaturesEXT validationFeatures = {
		...
		.pNext = NULL,
		.enabledValidationFeatureCount = ArraySize(validationFeaturesEnable),
        ...
        */
        ...
        VK_CHECK(vkCreateInstance(&instance_info, 0,  &context->instance_context.instance));
        ...
        (PFN_vkCreateDebugUtilsMessengerEXT)vkGetInstanceProcAddr(context->instance_context.instance, "vkCreateDebugUtilsMessengerEXT");
        PASSERT(func, "Debug creation failed");
        VK_CHECK(func(context->instance_context.instance, &debug_create_info, context->instance_context.allocator, &context->instance_context.debug_messenger));
